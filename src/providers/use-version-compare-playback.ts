...
import { clampTime } from "#/lib/version-compare/waveform";
...
interface UseVersionComparePlaybackOptions {
	getAnnotationsForFile: (audioFileId: string) => Annotation[];
	getWorkspaceState: (songId: string) => WorkspaceState;
	snapshotRef: MutableRefObject<VersionCompareSnapshot>;
}

export function useVersionComparePlayback({
	getAnnotationsForFile,
	getWorkspaceState,
	snapshotRef,
}: UseVersionComparePlaybackOptions) {
