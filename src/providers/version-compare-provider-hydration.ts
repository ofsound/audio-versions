...
import {
	...
	createEmptySettings,
	normalizeVersionCompareSettings,
...
export const EMPTY_SNAPSHOT: VersionCompareSnapshot = {
	songs: [],
	audioFiles: [],
	annotations: [],
	blobsByAudioId: {},
...
export async function normalizeLoadedSnapshot(
	loadedSnapshot: VersionCompareSnapshot,
) {
	...
	return {
		...
		normalizedSnapshot: {
			...
			settings: normalizeVersionCompareSettings(
