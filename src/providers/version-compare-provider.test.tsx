...
import { createEmptySettings } from "#/lib/version-compare/types";
import {
	useVersionCompare,
	VersionCompareProvider,
} from "./version-compare-provider";
...
vi.mock("#/lib/version-compare/db", () => ({
...
function Probe() {
	const { ready, audioFiles } = useVersionCompare();
...
describe("VersionCompareProvider", () => {
	beforeEach(() => {
