...
export interface VersionCompareUiSettings {
...
export function createDefaultUiSettings(): VersionCompareUiSettings {
	return {
...
export function createEmptySettings(): VersionCompareSettings {
	return {
		recents: [],
		workspaceBySongId: {},
...
export function normalizeUiSettings(
	value: Partial<VersionCompareUiSettings> | null | undefined,
...
export function normalizeVersionCompareSettings(
	value: Partial<VersionCompareSettings> | null | undefined,
