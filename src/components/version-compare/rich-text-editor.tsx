...
import { DEBOUNCE_MS } from "#/lib/version-compare/debounce-delays";
import { parseSongTarget } from "#/lib/version-compare/links";
import { EMPTY_RICH_TEXT } from "#/lib/version-compare/rich-text";
import type { RichTextDoc, SongLinkTarget } from "#/lib/version-compare/types";
...
export function RichTextEditor({
	...
	return (
		<div
			...
			data-version-compare-editor={focusId}
					...
					<ToolbarButton
						...
						onClick={() => {
							...
							const href = window.prompt(
								"Paste a URL or an internal Version Compare link.",
								existing ?? "",
							);
